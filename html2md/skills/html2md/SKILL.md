...
# 指定输出目录（默认 outputs/）
acorn html2md convert filing.html -o ./outputs

# 按公司组织输出
acorn html2md convert TCOM_携程_2024_an.html -c
...
```bash
# 转换目录下所有 HTML（输出到 outputs/）
acorn html2md batch ./downloads -c

# 按公司组织 + 跳过已有
acorn html2md batch ./downloads -c -s

# 递归搜索 + 纯文本输出
acorn html2md batch ./downloads -r -p -c

# 自定义输出目录
acorn html2md batch ./downloads -o ./outputs -c -s
```
