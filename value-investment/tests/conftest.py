...
provider_us_src = Path(__file__).parent.parent / "provider_market_us" / "src"
...
for src_path in [vi_core_src, provider_a_src, provider_hk_src, provider_us_src, fields_ifrs_src, fields_ext_src]:
