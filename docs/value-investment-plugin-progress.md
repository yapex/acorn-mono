...
```bash
# 查询数据
v-invest query 600900 -r "roe,net_profit_margin,pe_ratio,market_cap" -y 5

# 查询并计算隐含增长率
v-invest query 600900 -r "operating_cash_flow,market_cap" -y 5 -c implied_growth --wacc 0.08

# 列出所有可用字段
v-invest list-fields
...
```
=== 600900 查询结果 ===
字段: operating_cash_flow,market_cap,implied_growth
年份范围: 2022 - 2026

+---------------------+---------+---------+---------+
| Field               | 2024    | 2023    | 2022    |
+=====================+=========+=========+=========+
| operating_cash_flow | 596.48亿 | 647.19亿 | 309.13亿 |
+---------------------+---------+---------+---------+
